...
class FreeDebug {
	...
	public static function debug($message = 'END:', $trace = array(), $begin = '', $end = '') {
		$runtime = self::getExecTime();
		$useMem = self::getMemUsage();
		$separate = "<br/>&nbsp;&nbsp;";
		$trace = implode("{$separate}&nbsp;&nbsp;", self::trace($trace));
		$debug = '<div style="position: relative;top:5px;width:100%; color:#666666; text-align:left;"><hr>';
