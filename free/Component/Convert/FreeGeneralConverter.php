<?php
namespace Component\Convert;
/**
 * 通用编码转化类
 *
 */
class FreeGeneralConverter implements IFreeConverter {
	 ...
	 */
	public function FreeGeneralConverter($sourceLang = '', $targetLang = '', $forceTable = false) {
