...
final class FreeOracleDb extends AbstractFreeDb  {
	...
	**/
	...
	public function getFields($table) {
		...
		$sql = "SELECT a1.COLUMN_NAME as COLUMN_NAME,a1.DATA_TYPE as DATA_TYPE,a1.DATA_PRECISION as DATA_PRECISION,a1.DATA_SCALE as DATA_SCALE,a1.DATA_PRECISION as DATA_PRECISION,
a1.NULLABLE as NULLABLE,a1.DATA_DEFAULT as DATA_DEFAULT,a1.CHAR_LENGTH as CHAR_LENGTH,a2.COMMENTS as COMMENTS 
                FROM user_tab_columns a1 left join user_col_comments a2 on a1.COLUMN_NAME = a2.COLUMN_NAME and a1.TABLE_NAME=a2.table_name where a1.table_name='$table'";
