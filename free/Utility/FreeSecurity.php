...
class FreeSecurity {
	 ...
	 * @return string
	 */
	public static function charReplace($str)
	{
		$search = array (
			'%20',
			'%27',
	 ...
	 * @return string
	 */
	public static function tagReplace($str)
	{
	 ...
	 * @return string
	 */
	public static function safeContentInput($str) 
	{	
		$search = array (
			"'<(script|iframe|frame|textarea|select|input|form|button|link)[^>]*?>.*?</(script|iframe|frame|textarea|select|input|form|button|link)>'si",
		);
		$replace = array (
			"",
		);		  
	 ...
	 * @return string
	 */
	public static function safeContentOutput($str) 
	{	
	 ...
	 * @return string
	 */
	public static function safeTextInput($str) 
	{	
	 ...
	 * @return string
	 */
	public static function safeTextOutput($str)
	{	
		if(function_exists('htmlspecialchars_decode'))
			$str = htmlspecialchars_decode($str);
		else
