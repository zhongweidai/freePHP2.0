...
<div class="wrap">
<div class="main">
<h2><?php echo "ErrorCode [$code]"?></h2>
<h3><?php echo "Uncaught error with message: $message"?></h3>

<h2>File:</h2>
<h3><?php echo $file,':',$line; ?></h3>
<!--
<h2>__Stack:</h2>
<h3><?php /*echo $file,':',$line; */?></h3>-->
<div class="tips"><?php echo "The server encountered an internal error and failed to process your request. 
Please try again later. If this error is temporary, reloading the page might resolve the problem.
\nIf you are able to contact the administrator report this error message."; ?></div>
</div>
</div>
</body>
</html>